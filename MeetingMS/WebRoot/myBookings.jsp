        ...
        <tr>
          ...
          <div class="button_link">
             <c:if test="${item.key.status.equals('0')}">
                <a class="clickbutton" href="ViewMyBookingDetailServlet?meetingid=${item.key.meetingid}" style="text-decoration:none;">查看/取消</a>
             </c:if>
             <c:if test="${item.key.status.equals('1')}">
                <a class="clickbutton" href="ViewMyBookingDetailServlet?meetingid=${item.key.meetingid}" style="text-decoration:none;">查看（已取消）</a>
             </c:if>
